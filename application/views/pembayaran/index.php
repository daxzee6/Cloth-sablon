              ...
              ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($tb_sales['bukti_bayar']==$bukti_bayar):?>
                        ...
                        <?php else: ?>
                        <img src="<?= base_url('assets/image/bukti_bayar/').$tb_sales['bukti_bayar'] ?>"
                            style="width: 60px; cursor:pointer;" alt="bukti pembayaran" class="buktibayar">
                        ...
                        <span>
                            ...
                            <div class="btn-floating btn-small red darken-2  tooltipped"
                                ...
                                <a href="#modalKirim<?= $tb_sales['id_sales'] ?>" class="modal-trigger"><i
                                        class="material-icons">report</i></a>
                            </div>
                    ...
                    <div class="row">
                        <div class="col s12">
                            <div class="row">
                                ...
                                <div class="col s6">
                                    <p>Design Sablon</p>
                                    <img src="<?= base_url('assets/image/design_sablon/').$jual['design_sablon'] ?>"
                                        style="width: 60px; cursor:pointer;" alt="bukti pembayaran" class="buktibayar"
                                        class="bukti_bayar">
