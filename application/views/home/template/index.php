 ...
 <main>
     <div class="row">
         <div class="col s12">
             <div class="slider">
                 <ul class="slides">
                     <li>
                         <img src="<?= base_url('assets/image/Polo.png') ?>" style="display: block;
                                   margin-left: auto;
                                   margin-right: auto;
                                   height:auto;
                                   width: 50%;" />
                     ...
                     <li>
                         <img src="<?= base_url('assets/image/Kaos.png') ?>" style="display: block;
                                   margin-left: auto;
                                   margin-right: auto;
                                   height:auto;
                                   width: 50%;" />
     ...
     <div class="row grey lighten-3">
         <h1 class="center teal-text text-lighten-1 "><span class="black-text">Catalog</span></h1>
