    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6">
                <img src="<?php echo base_url() ?>assets/image/cloth.png" alt="logo" style="width:100%;margin:10 10;">
            ...
            <div class="col s12 m6">
                ...
                <p>Jl. Mandor Goweng RT05/RW03 No.21, KUKUSAN RW 03 Kota Depok. 16425</p>
            </div>
        </div>
    </div>
    <div class="footer-copyright center">
        <div class="container">
            © 2024 Copyright Cloth.Co
        </div>
    </div>
</footer>
<!-- end of footer -->
